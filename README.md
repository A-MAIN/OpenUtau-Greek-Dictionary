...
Greek Dictionary for OpenUTAU, based on the Wikipron list of entries, modified for easier use.

this dictionary is to be used by the ds dict yaml file for a diffsinger bank, or any Greek CVVC utau bank with the use of a phonemizer.
